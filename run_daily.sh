...
export RECORD_TIMEOUT_SECONDS=${RECORD_TIMEOUT_SECONDS:-0}
export MAX_RECORD_AUDIO_SECONDS=${MAX_RECORD_AUDIO_SECONDS:-0}
...
export ASR_CHUNK_SECONDS=${ASR_CHUNK_SECONDS:-0}
export ASR_OOM_CHUNK_SECONDS=${ASR_OOM_CHUNK_SECONDS:-60}
export ASR_CHUNK_BOUNDARY_WINDOW_SECONDS=${ASR_CHUNK_BOUNDARY_WINDOW_SECONDS:-30}
export ASR_CHUNK_MIN_SILENCE_MS=${ASR_CHUNK_MIN_SILENCE_MS:-600}
export ASR_CHUNK_SILENCE_DB=${ASR_CHUNK_SILENCE_DB:-16}
